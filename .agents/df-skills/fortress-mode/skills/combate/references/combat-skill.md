...
> Fonte: [Combat skill](https://dwarffortresswiki.org/index.php/Combat_skill) — Dwarf Fortress Wiki (GFDL/MIT)
...
- **Pikeman** - allows characters to use pikes "pike") more effectively.
