...
> Fonte: [Jeweler's workshop](https://dwarffortresswiki.org/index.php/Jeweler's_workshop) — Dwarf Fortress Wiki (GFDL/MIT)
...
The first way is to specify the task details. After the task has been created the gem type can be specified by clicking the magnifying glass icon ( in Classic) and selecting the rough gem type there.
...
- You may also cut normal stones in the jeweler's workshop. These stones will always come out as cabochons, while other gems will come out as cut gems. The difference being that a cabochon is just a cut and polished stone, whereas a gem is a gem. Some rough gems are also always cut as cabochons, this is dependent on the opacity or transparency of the stone.
