...
> Fonte: [Clutter](https://dwarffortresswiki.org/index.php/Clutter) — Dwarf Fortress Wiki (GFDL/MIT)

**Clutter** will occur in workshops when they become full of goods that are not hauled away to stockpiles. A workshop that is cluttered will display (CLT) when viewed via the or menus. , "View Items in Buildings," will show you what items are cluttering the workshop.
...
- Cooking with eggs creates extreme kitchen clutter.
