...
> Fonte: [Dwarf cancels task: Dangerous terrain](https://dwarffortresswiki.org/index.php/Dwarf_cancels_task:_Dangerous_terrain) — Dwarf Fortress Wiki (GFDL/MIT)
...
Solid furniture without a "walkable" surface also counts as dangerous terrain. For instance, a dwarf standing on the top of a raised bridge will cancel its job, with this cancellation message. Trees growing through bridges can override the "walkable" tag, leading to dangerous terrain alerts.
