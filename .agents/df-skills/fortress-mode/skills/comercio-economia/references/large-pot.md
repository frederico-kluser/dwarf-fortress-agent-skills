...
> Fonte: [Large pot](https://dwarffortresswiki.org/index.php/Large_pot) — Dwarf Fortress Wiki (GFDL/MIT)
...
- Pots will not be used for processing sweet pods into dwarven syrup.
- Dwarves will sometimes leave pots in furniture stockpile even when using them to store food.
