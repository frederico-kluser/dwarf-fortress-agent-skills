...
> Fonte: [Legendary artifact](https://dwarffortresswiki.org/index.php/Legendary_artifact) — Dwarf Fortress Wiki (GFDL/MIT)
...
Dwarves drop artifacts in the workshop as soon as they are made. They can be traded, just like any item of their type, or stolen, sold or warred over, and may transfer between civilizations in those ways. A list of all artifacts in the fortress can be seen by pressing ( in version 0.40).
...
- In adventure mode, named items and artifacts disappear from inventory after leaving site.
- Artifact weapons get less sharpness than they should.
