...
Note that the meat industry involves many materials which can rot, and therefore requires slightly more micromanagement than other industries.
...
The basic units of the meat industry are its animals, of which the acquisition presents a number of methods (note that the related fishing industry is its own matter).
...
Animals that don't require a constant stream of plant matter, like poultry, can be put in any pasture (or cage). The basis of egg production is a pasture with nest boxes in it.
