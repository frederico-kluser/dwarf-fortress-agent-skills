...
> Fonte: [Stone management](https://dwarffortresswiki.org/index.php/Stone_management) — Dwarf Fortress Wiki (GFDL/MIT)
...
- **Advantages**:
  ...
  - You can use ,, to hide all the stone in a dump quickly.
...
- **Disadvantages**:
  ...
  - You have to claim stones for them to be used after they are dumped. ,, will allow you to claim an entire pile of stones quickly.
...
Extra stone lying around in out-of-the-way areas causes little problems beyond being unsightly. You can hide stones individually using -. You might need to scroll in the Loo menu to choose the stone you wish to hide. You can hide many stones at a time by using the designate menu: choose -- and then select the stone you wish to hide by mouse or rectangle.
...
You can use excess stones to construct a floor (--) on any standard floor tile. Similarly, you can construct a paved road or a bridge, with the added benefits of training your architect and providing the possibility for your dwarves to experience happy thoughts when walking across the tile.
...
- **Disadvantages**:
  ...
  - When removing a constructed floor over a high-value base tile (gems, ore), the floor may revert to the layer stone type (significantly reducing the value).
