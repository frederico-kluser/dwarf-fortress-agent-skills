...
> Fonte: [Reports](https://dwarffortresswiki.org/index.php/Reports) — Dwarf Fortress Wiki (GFDL/MIT)

**Reports** are messages detailing either combat (both practiced and real) between creatures, or events that took place during a mission. The list goes on for quite a while (up to 11 pages, in fact), but only relatively recent combat or missions will have detailed reports (accessible with ) attached, out to a year.
...
New reports generate flags on the side of the screen while unread. All flags/indicators disappear from the main view after you visit the Reports menu by hitting . The tiles depicted below are those that appear for the report type.

A combat report is red, and will be reported on the main menu as "\ is fighting!" Note that a hunted animal will be considered fighting.\

A hunting report is green, and describes that "the \ \ is hunting."\

A sparring report is in cyan, and will be indicated as "\ is sparring."\

A mission report is in yellow, and will be indicated as "Mission Report: \ (Set out \ \)"\

A mission spoils report is in yellow, and will be shown as "Spoils Report: \, \ \"\

A new tribute report is available, and will appear as "Tribute Report: \, \ \" in yellow\

A new Interrogation report is available. It will appear in the Alerts in cyan.
