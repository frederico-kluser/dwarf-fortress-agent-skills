...
Completed megaprojects should be uploaded to the Dwarf Fortress Map Archive and posted on the Bay12 Forums. Incredible feats of construction are usually very fun, so you'll see many different (and probably similar) constructions across the wiki.

Use whatever ideas you think are ingenious. More project ideas can be found where stupid dwarves try crazy tricks - for some smaller-scale project ideas that still embody the dwarven spirit, see the style projects page.
...
- Knife Bonus: Make a mass tomb specially designed for hippies that is suspended above the entrance to your fortress.
...
CandyFlossBonus: Rebuild the mountain out of candy floss.
...
BONUS: When migrants arrive at the pearly gates, view their thoughts and preferences and only allow those with a similar/same Deity as your population.\
...
1.  It's a gigantic drowning chamber for Elves.
2.  Construct a very long wall all the way around a forest retreat
...
2.  Drainage can be done with a floodgate to release the water from the depot.
...
*"There is one tale that tells about a place that only few have seen, and even fewer have returned from... A place beyond the grasp of our hands, beyond the reach of our picks... A place composed of stone that has been there since the beginning, and will remain there after our demise... A stone unmoved by the swing of our picks, material that only fools would demand... Yet we managed to scratch its surface, and now we plan to cast an entire history of our kin onto it, an artwork that no magma will melt, no beasts nor men will ever be able to destroy. A true dwarf would want to go for it. And you surely do."*

- Bonus: Also engrave walls of the pits.
- LegendaryBonus: Use only legendary engravers.
- ☼LEGENDARY BONUS☼: Make sure every engraving has masterwork quality.
...
Capture a female necromancer, install her in a dark-colored fortress, and give her the corpses of spider monkey men to resurrect. If you like, mod them to be able to fly.
...
- Bonus: travel around and actually release the circus on every embark. Needless to say, this is the most fun option. You may consider making sure the clowns get their share of fun, if you want your circus to happen more than once...

### Make family tree for characters

Go to a free family tree generator and add as many characters as you want/can (this website is a good choice). Not even Legends Viewer will be able to compete with the sheer awesomeness of having the list of your dwarves' relatives (and kills) right up to year one.
...
- Masochism bonus: give figurative trees to those tree-huggers and make a tree for nigh-immortal (and who mate like bunnies unicorns) elves.
...
- Artifact bonus: somehow get a hold of a legendary dwarf character's savegame, and show us who their ancestors were.
...
- Fire Turret: Trap magma crabs and fire imps in magma safe cage traps from the magma sea and make a tower.
- Dwarven Traps
- VERY Dwarven Traps
- Your most Skilled Fighters
...
- Boss Wave: Cellar Dwellers and Nomadic Threats
- Final Wave: The Clowns
...
- Wall off that special cavern below the magma sea.
