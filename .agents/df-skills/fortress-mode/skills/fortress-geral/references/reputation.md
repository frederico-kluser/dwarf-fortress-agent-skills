...
> Fonte: [Reputation](https://dwarffortresswiki.org/index.php/Reputation) — Dwarf Fortress Wiki (GFDL/MIT)
...
| Friendly Fighter | Corresponds to 'on my side' utterance, implies that the figure considers you someone who they otherwise are unconnected to, but is the enemy of their enemy. |
...
| Monster | Reserved for megabeasts and other named animals, not possible to obtain in unmodded DF. |
...
| Quarreler | Unknown, presumably obtained by pressing or arguing when a disagreement is reached through a value statement . |
| Flatterer | Obtainable by failing to flatter a figure repeatedly. . |
...
| Thief | Seems unobtainable right now . |
