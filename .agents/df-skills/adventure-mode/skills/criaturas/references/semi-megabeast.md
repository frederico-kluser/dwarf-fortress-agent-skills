...
> Fonte: [Semi-megabeast](https://dwarffortresswiki.org/index.php/Semi-megabeast) — Dwarf Fortress Wiki (GFDL/MIT)

**Semi-megabeasts** are special and powerful 'boss' creatures who are created during world generation, each associated with at least two spheres. They are named historical figures, and the game will announce their presence by name. They are similar to megabeasts, but tend to be smaller, not as powerful and more numerous.
