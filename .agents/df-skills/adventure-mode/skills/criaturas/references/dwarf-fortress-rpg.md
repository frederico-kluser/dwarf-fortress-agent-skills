...
> Fonte: [Dwarf Fortress RPG](https://dwarffortresswiki.org/index.php/Dwarf_Fortress_RPG) — Dwarf Fortress Wiki (GFDL/MIT)

**Multiplayer Adventure Mode**, also known as the **DF Role-Playing Game**, was a fun little gaming get-together of a few players from the forums using the QAGS role-playing system. These are the game logs and summaries of each session. The original forum thread:
