...
> Fonte: [Dungeon (structure)](https://dwarffortresswiki.org/index.php/Dungeon_(structure)) — Dwarf Fortress Wiki (GFDL/MIT)
...
Dungeons were removed from the game in version 0.47.01, with plans for better replacements in a future update. Interestingly, Legends will sometimes mention particularly unsavory tower "tower") tenants adding dungeons as extensions to their dwellings and holding prisoners there for various reasons, but inspecting these towers in adventure mode currently shows no evidence of such chambers existing. This does suggest, however, that the future replacement dungeons will serve a more obvious purpose as containment for prisoners. ^([\[1\]](http://www.bay12forums.com/smf/index.php?topic=175790.msg8107044#msg8107044))
