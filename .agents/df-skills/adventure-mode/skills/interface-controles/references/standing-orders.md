...
> Fonte: [Standing orders](https://dwarffortresswiki.org/index.php/Standing_orders) — Dwarf Fortress Wiki (GFDL/MIT)
...
**Standing orders** that apply to the whole fortress can be accessed by opening the Labor menu with and then clicking on the **Standing orders** tab.
