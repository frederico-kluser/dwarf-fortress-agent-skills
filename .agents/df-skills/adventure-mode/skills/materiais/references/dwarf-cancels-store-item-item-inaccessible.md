...
> Fonte: [Dwarf cancels Store Item: Item inaccessible](https://dwarffortresswiki.org/index.php/Dwarf_cancels_Store_Item:_Item_inaccessible) — Dwarf Fortress Wiki (GFDL/MIT)
...
Determining what item is causing this and forbidding it usually solves the problem. You may have luck with looking into jobs screen and examining jobs or disabling your stockpiles one at a time to see which one will stop the spam.
