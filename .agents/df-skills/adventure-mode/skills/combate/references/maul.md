...
> Fonte: [Maul](https://dwarffortresswiki.org/index.php/Maul) — Dwarf Fortress Wiki (GFDL/MIT)
...
In fortress mode, one-handed vs. two-handed checks are performed correctly, but can wield vs. can't wield ignores height and broadness modifiers, so dwarves cannot equip mauls. See this forum post for details.
