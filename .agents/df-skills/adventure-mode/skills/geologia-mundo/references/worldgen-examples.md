...
Named after a thread where the first known example of this sort of world was played in Adventurer Mode. An outsider-only world that condenses an entire world's worth of monsters into a single volcanic island. Note that it WILL reject infinitely until you allow it to accept any reject.
