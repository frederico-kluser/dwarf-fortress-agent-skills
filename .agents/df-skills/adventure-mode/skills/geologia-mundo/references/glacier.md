...
2.  If you're going to use the reservoir for irrigation then dig an outlet from the reservoir at the F, install a floodgate at its mouth, and hook it up to a lever.
3.  Dig a tunnel to the pool, leaving one tile's worth of stone between the tunnel and the water (the X in the diagram).
4.  Install a floodgate or a south-raising drawbridge at the end of the tunnel and hook it up to a lever.
