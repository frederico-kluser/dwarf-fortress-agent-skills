...
> Fonte: [Chicory](https://dwarffortresswiki.org/index.php/Chicory) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes chicory for their taste.**
- **Seed**
- **/ Chicory seeds**
- **Seasons**
...
**Chicory** is an aboveground garden plant. It can be planted in all seasons and is edible raw or cooked.

Wild ones flower, turning your landscape a pleasant blue hue.

Some dwarves like chicory for its *taste*.
