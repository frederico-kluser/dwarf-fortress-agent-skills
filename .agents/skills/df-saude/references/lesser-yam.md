...
> Fonte: [Lesser yam](https://dwarffortresswiki.org/index.php/Lesser_yam) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes lesser yam plants for their tubers.**
- **Seed**
- **/ Lesser yam seeds**
- **Seasons**
...
**Lesser yams** are an aboveground garden plant. They can be planted in all seasons and are edible when cooked.

Some dwarves like lesser yam plants for their *tubers*.
