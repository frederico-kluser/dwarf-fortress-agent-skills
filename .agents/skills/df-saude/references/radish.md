...
> Fonte: [Radish](https://dwarffortresswiki.org/index.php/Radish) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes radish plants for their edible roots.**
- **Seed**
- **/ Radish seeds**
- **Seasons**
...
**Radishes** are an aboveground garden vegetable. They can be planted in all seasons, is edible raw or cooked, and can also be brewed into radish wine or processed in a dyer's shop into pale pink dye.

Some dwarves like radish plants for their *edible roots*.
...
Radish wine tastes not unlike despair.
