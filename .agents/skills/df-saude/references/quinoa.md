...
> Fonte: [Quinoa](https://dwarffortresswiki.org/index.php/Quinoa) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes quinoa for their beer.**
- **Seed**
- **/ Quinoa seeds**
- **Seasons**
...
**Quinoa** is an aboveground crop that can either be milled into quinoa flour or brewed into quinoa beer.

Some dwarves like quinoa for its *beer*.
