...
> Fonte: [Broad bean](https://dwarffortresswiki.org/index.php/Broad_bean) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes broad bean plants for their pods.**
- **Seed**
- **/ Broad beans**
- **Seasons**
...
**Broad beans** are an aboveground garden plant. They can be planted in all seasons. Only the seeds when cooked are edible.

Some dwarves like broad bean plants for their *pods*.
...
\
Elves are said to enjoy garnishing their usual fare with these beans and a nice grape wine.
