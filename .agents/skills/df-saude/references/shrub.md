...
> Fonte: [Shrub](https://dwarffortresswiki.org/index.php/Shrub) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

A shrub is a small plant that grows naturally, as opposed to a domesticated farm crop. They can be found all over the world in grassy areas, savannas, forests, and deserts. They will also sprout on soil and muddy stone underground if a cavern has been breached. Shrubs are instrumental for plant gathering, and in environments with a significant amount of vegetation, they can be an excellent supply of food. Gathering shrubs also serves to provide a supply of seeds for use in planting surface crops, such as longland grass and strawberries.
...
To collect plants, find green, healthy bushes –  (`"`) – rather than the dead or dried-up brown ones –  (`"`) – and set plant g gathering orders. Dwarves with the herbalism labor enabled and little else to do will rush out and start trying to gather plants. Skill is checked for every shrub, similar to a quality check; proficient (or higher) herbalists without skill penalties always harvest at least one plant per bush, but the yield is generally lower than from a farm. There is usually plenty of available vegetation however, so designate a wide area and leave them to it. It is also possible to designate a z zone for plant gathering. The herbalist will be triggered every season to gather plants in the designated zone.
...
There are also underground shrubs, unlike those found on the surface. In ASCII mode, they appear as color-coded colons rather than green quotation marks –  (`:`) for plump helmets,  (`:`) for sweet pods,  (`:`) for cave wheat,  (`:`) for dimple cups, and  (`:`) for pig tails or quarry bushes.
