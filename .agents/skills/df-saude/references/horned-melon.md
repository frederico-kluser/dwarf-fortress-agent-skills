...
> Fonte: [Horned melon](https://dwarffortresswiki.org/index.php/Horned_melon) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes horned melon vines for their fruit.**
- **Seed**
- **/ Horned melon seeds**
- **Seasons**
...
**Horned melon** is an aboveground garden plant. They can be planted in all seasons and the fruit is edible raw or cooked.

It is one of the few crops whose fruit uses a ☼ instead of a %.

Some dwarves like horned melon vines for their *fruit*.
