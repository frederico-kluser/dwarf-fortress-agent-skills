...
> Fonte: [Watermelon](https://dwarffortresswiki.org/index.php/Watermelon) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes watermelon vines for their fruit.**
- **Seed**
- **/ Watermelon seeds**
- **Seasons**
...
**Watermelons** are an aboveground garden fruit. They can be planted in all seasons and the fruit is edible raw or cooked. Fruits also can be processed in a dyer's shop into orchid pink dye.

Some dwarves like watermelon vines for their *fruit*.
