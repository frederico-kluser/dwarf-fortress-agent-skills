...
> Fonte: [Spelt](https://dwarffortresswiki.org/index.php/Spelt) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes spelt for their beer.**
- **Seed**
- **/ Spelt seeds**
- **Seasons**
...
**Spelt** is an aboveground crop. It can either be milled into spelt flour or brewed into spelt beer.

Some dwarves like spelt for its *beer*.
