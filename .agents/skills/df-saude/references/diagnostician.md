...
> Fonte: [Diagnostician](https://dwarffortresswiki.org/index.php/Diagnostician) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
Diagnose wounded dwarves / Ponder / Discuss / Research
...
Diagnostician skill level is related to the speed at which the labor is completed, and it also affects the probability of identifying any active syndromes. It is the only relevant skill of the chief medical dwarf noble position. Graphically, diagnosticians wear all black clothes.

Contrary to popular belief, an unskilled diagnoser will **not** misdiagnose injuries and prescribe inappropriate treatments.

Diagnosers determine the freshest hell unleashed on your fortress' injured as part of the health care industry. The diagnostician skill is also used by scholars when thinking about medical science-related topics:
...
This occupation is affected by the healthcare labors bug.
