...
> Fonte: [Pasture](https://dwarffortresswiki.org/index.php/Pasture) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
Pasturing a cat in a food stockpile will make it more effective at keeping vermin away from your food (or any creature with a [`[HUNTS_VERMIN]`](/index.php/Creature_token#HUNTS_VERMIN "Creature token") or [`[DIVE_HUNTS_VERMIN]`](/index.php/Creature_token#DIVE_HUNTS_VERMIN "Creature token") token).

Lots of 1×1 pastures, each with a chicken and a nest box, is a way to make a battery farm.
