...
> Fonte: [Wear](https://dwarffortresswiki.org/index.php/Wear) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
- Items suffer accelerated wear when their temperature falls below their base material's COLDDAM_POINT (such as wood and cloth items stored aboveground in a trade depot or starting wagon "Wagon (embark)") in a glacier biome). Walls do not halt this effect.
