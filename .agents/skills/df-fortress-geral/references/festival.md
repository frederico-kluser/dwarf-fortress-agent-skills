...
> Fonte: [Festival](https://dwarffortresswiki.org/index.php/Festival) — Dwarf Fortress Wiki (GFDL/MIT)
...
Festivals cannot be seen in play, though it is planned at some point to allow adventurers to participate in the activities. Because the latter is not possible yet, festivals do not happen after world gen ends ^(1 2). As it stands, festivals are currently a very minor mechanic that provides background flavor.
