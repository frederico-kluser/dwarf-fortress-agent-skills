...
> Fonte: [Edge](https://dwarffortresswiki.org/index.php/Edge) — Dwarf Fortress Wiki (GFDL/MIT)

Materials have a sharpness property, defined as . In combat, this presumably defines how well the material works when used for slashing attacks.
