...
> Fonte: [Screenshot](https://dwarffortresswiki.org/index.php/Screenshot) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

These instructions explain how to create a **screenshot** to save or post on a wiki, forum, or elsewhere.

## Capturing the image

1.  Make the screen look how you want it - centered, open programs, etc. A screenshot will show exactly what's displayed on your monitor or in the active window (unless you edit the image, which is not hard).
...
For example, if we type this:
    ...
    [[Image:Copper_strike.PNG|thumb|right|200px|''(click to enlarge)''
