...
> Fonte: [Combat](https://dwarffortresswiki.org/index.php/Combat) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
Animation of an armored dwarf and armored human in a fight to the death.
...
|  |
|----|
| "Combat" in other / Languages / Dwarven / : / zoluth / Elven / : / moÿira / Goblin / : / nur / Human / : / thec |

Reading the combat N reports will give you a gruesome blow-by-blow of the fighting, telling you exactly what each strike did. It is important to note that, while most natural creatures have the same sorts of vulnerabilities due to their similar collections of body parts, procedurally-generated creatures such as bogeymen, forgotten beasts and titans may lack these vulnerabilities entirely. Killing a shambling pile of refuse may prove to be a very, very long process due to the fact that it has no vital parts, and metallic creatures may prove to be nearly invulnerable. When all else fails, a cave-in or obsidian casting means certain death for anything caught in it.
...
|  |  |
| 5 | Attack hostile creature on same tile |
| A | Attack an adjacent creature |
| W | Wrestle an adjacent creature |
| f | Fire a projectile |
| t | Throw an item |
| X | Use ability or power |
| j | Jump |
...
Weapons can become stuck in wounds after an attack - this will make the weapon unavailable for aimed attacks. There are multiple ways to free them. The most reliable is by I interacting with the weapon in inventory, choosing the weapon, and choosing the Gain possession option. Other ways include; doing a non-aimed attack can free up a stuck weapon (but if you're holding multiple weapons this isn't certain to work); moving from your current tile (exposing your back or flank to the enemy is not recommended); moving the enemy from their *own* tile by wrestling throw or charging attack; or jumping into the enemy.

Most creatures have body parts that can be used as weapons; hands, nails, feet, and mouths are common. These allow the creature to punch, scratch, kick, and bite, which use the Striker, Kicker, and Biter combat skills. Creatures with other body parts may have an added attack with those; horns or tusks add gore attacks, for example. Creatures may also have attacks as natural abilities or acquired powers which can be used with X. Spit is a common ability, but is not very effective.

The entire body can also be used as a weapon by j jumping into or through the tile a creature is in. Usually they will dodge, but that might be useful around dangerous terrain. If it does hit, they may be sent flying depending on your relative masses. This can be useful for crowd control or knocking enemies into pits. Having your weapon stuck in them seems to increase the chance of hitting them.

### Melee attacks

Hostile creatures can be attacked using a non-aimed attack by simply moving towards your enemy using the movement keys. A hostile creature in the same tile as you can be attacked with 5. The specific type of attack can be influenced by the combat preferences and may be influenced by the character's skill level for each type of attack.\[Verify\]

Any visible creature can be attacked by standing next to it and pressing A or W. Attacking some creatures will require a confirmation, given using alt+y. This can be because they're friendly (which includes wild animals for elves), unconscious, or have yielded. This menu also has wrestling and defensive options.
...
**Wrestling** (grappling) can be performed by selecting an enemy via W to wrestle. You can wrestle any enemy. Wrestling works somewhat like a targeted attack: Once you grab a creature by some body part, you may be able to make another wrestling attempt that will allow you to perform a throw or takedown. For a detailed list of moves, such as takedowns, throws, choke holds, etc., see Wrestling.

### Wounds

If you get wounded during combat, you can try to yield or flee - or both - before you get more wounded. To yield, press y. This will be less effective if you continue to hold a weapon, so drop any with d. Putting them away with q or p may also work. You can also ask them to cease hostilities with k. However, depending on the hostility level of the conflict, and possibly the personality of your enemy, they may continue to attack you.

If you choose to flee, you can increase your movement speed with m. Be aware that movement speed while stunned, nauseous or winded is reduced, and might leave you open to fatal blows. If you are next to a creature, manually dodging using the A attack menu may be faster than using the movement keys, and will likely avoid more attacks.

Your wounds will heal over time, so just fast travel or sleep in a safe place. Some wounds may never heal, however, leaving you permanently crippled - obtaining a crutch may help with this. Or, if you are not already a vampire, you can get bitten by a werebeast during full moon, which will heal all injuries once per month. Rolling divination dice can also result in a transformation or direct healing, though such magical healing seems to also have limits. Finally, you might come across a very rare healing substance.

If you have some bolts or arrows stuck in your body, they can be removed by using the complex I interaction menu. Select the stuck bolt or arrow from the list, and then pull it out with a. You'll probably start bleeding after you pull it out, but the bleeding is rarely anything to worry about.
...
|  | **Wrestle** | A set of attacks based on wrestling moves, naturally using one's limbs to attack. |
|  | **Grab** | Takes hold of an enemy's body part. |
|  | **Joint Lock** | Push or pull an enemy's joint to its maximum degree of motion, putting the combatant in pain and further preventing movement. |
|  | **Choke** | Grabs the enemy with a choke hold, suffocating them if they need to breathe. |
|  | **Takedown** | Throws the enemy down, likely knocking them off their feet. |
|  | **Wrestle** | Send the enemy airborne. |
|  | **Pinch** | The user pinches an enemy's body part with their digits, fingers or pincers. |
|  | **Gouge** | Tears or claws into an enemy body part that has been grappled. |
|  | **Break** | Forcefully break an enemy bone, rendering the body part useless. |
|  | **Loosen** | Loosen or release the grip of a hold on an enemy. |
|  | **Strangle** | Grab and shake the throat of the enemy, suffocating them if they need to breathe. |
|  | **Latch** | Sharply bite into the victim, holding them in place. |
...
|----|----|----|
| Icon | Attack | Description |
|  | **Quick** | A weaker attack that is quick and easy to recover from. |
|  | **Heavy** | A strong attack that is slower and harder to recover from. |
|  | **Wild** | A fast attack, but is very inaccurate and hard to maintain the balance of. |
|  | **Precise** | A very slow, but very accurate attack. |
|  | **Charge** | Charges into the enemy, possibly making an enemy stumble off balance or knock them down. |
|  | **Multi-attack** | A sequence of attacks customizable by the player, when finished, they will all be executed one after the other. |
...
|----|----|----|
| Icon | Attack | Description |
|  | **Stab** | Strike the enemy by directly thrusting a sword's point. |
|  | **Slash** | Strike the enemy by swinging the edge of a sword at the enemy. |
|  | **Slap** | Hits the enemy with the flat side of a weapon. |
|  | **Hack** | Strike the enemy by swinging an axe or axe-like weapon into the enemy. |
|  | **Charge** | Strike the enemy with a blunt weapon. |
|  | **Lash** | Attack an enemy by lashing a whip at them. |
|  | **Pommel** | Bash an enemy with the handle of a weapon. |
|  | **Punch** | Swing a punch toward the enemy. |
|  | **Kick** | Kick the enemy. |
|  | **Bite** | Simply bite the enemy. A vampire can draw blood from a victim this way, or a werebeast can also transfer its curse with a bite that breaks the skin. Very effective if the attacker's bite is venomous. |
|  | **Sting** | Attack the enemy with a stinger, if the attacker naturally has a stinger. Very effective if the attacker's sting is venomous. |
|  | **Pincer** | Attack the enemy with a pincer, if the attacker naturally has a pincer. |
|  | **Push** | Shoves the enemy away. |
