...
Unfortunately, DF is not immune to bugs. While Toady fixes them as fast as he can, you might find some workarounds on the known bugs page. To report a new bug, check out the instructions for reporting new bugs.
