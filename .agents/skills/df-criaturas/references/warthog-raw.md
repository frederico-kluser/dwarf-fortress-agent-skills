...
> Fonte: [Warthog/raw](https://dwarffortresswiki.org/index.php/Warthog/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
1 kph[CREATURE:WARTHOG]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:warthog piglet:warthog piglets]
	[CREATURE_TILE:'W']
	[COLOR:6:0:0]
