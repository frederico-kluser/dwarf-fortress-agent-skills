...
> Fonte: [Cave swallow](https://dwarffortresswiki.org/index.php/Cave_swallow) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes cave swallows for their coloration.**
- **Biome**
...
**Cave swallows** are a species of unremarkable vermin which can be encountered in caverns. They can be captured by trappers and turned into low-value pets.

Some dwarves like cave swallows for their *coloration*.

Admired for its *coloration*.

|  |
|----|
| "Cave swallow" in other / Languages / Dwarven / : / äs mozib / Elven / : / garetho thicera / Goblin / : / omo nabok / Human / : / ngethac cocu |
