...
> Fonte: [Char](https://dwarffortresswiki.org/index.php/Char) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes char for their coloration.**
- **Biome**
...
**Char** are vermin-sized fish that can be caught by fisherdwarves and processed at a fishery, but only found in temperate rivers and lakes. Char can be caught year round.

Some dwarves like char for their *coloration*.
