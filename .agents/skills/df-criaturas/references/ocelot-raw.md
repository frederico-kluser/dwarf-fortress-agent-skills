...
> Fonte: [Ocelot/raw](https://dwarffortresswiki.org/index.php/Ocelot/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Stephmo[CREATURE:OCELOT]

	[DESCRIPTION:A small cat-like creature found in the jungle.]
	[NAME:ocelot:ocelots:ocelot]
	[CASTE_NAME:ocelot:ocelots:ocelot]
	[CHILD:3]
	[GENERAL_CHILD_NAME:ocelot kitten:ocelot kittens]
	[CREATURE_TILE:'o']
	[COLOR:6:0:1]
