# Peregrine falcon/raw

> Fonte: [Peregrine falcon/raw](https://dwarffortresswiki.org/index.php/Peregrine_falcon/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
John Tait from Harrow, Middlesex: "Hunting food for vermin"[CREATURE:BIRD_FALCON_PEREGRINE]
	...
	[BIOME:TUNDRA]
	[HOMEOTHERM:10067]
	[GAIT:FLY:Maximum Flight Speed:100:10:3:300:50:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:FLY:Faster Flight:200:5:3:300:10:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:FLY:Fast Flight:300:NO_BUILD_UP:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
