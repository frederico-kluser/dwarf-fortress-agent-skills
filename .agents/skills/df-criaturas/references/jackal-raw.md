...
> Fonte: [Jackal/raw](https://dwarffortresswiki.org/index.php/Jackal/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Cruxador[CREATURE:JACKAL]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:jackal pup:jackal pups]
	[CREATURE_TILE:'j']
	[COLOR:6:0:0]
