...
> Fonte: [Kangaroo/raw](https://dwarffortresswiki.org/index.php/Kangaroo/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Sponsored by Duncan Burke[CREATURE:KANGAROO]

	[DESCRIPTION:A medium-sized creature that can be found hopping through the grassland.]
	[NAME:kangaroo:kangaroos:kangaroo]
	[CHILD:1]
	[GENERAL_CHILD_NAME:kangaroo joey:kangaroo joeys]
	[CREATURE_TILE:'K']
	[COLOR:6:0:0]
	...
	[CREPUSCULAR]
	[HOMEOTHERM:10070]
	[GAIT:WALK:Fastest Walk:183:10:3:549:50:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Faster Walk:366:5:3:549:10:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Fast Walk:549:NO_BUILD_UP:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
