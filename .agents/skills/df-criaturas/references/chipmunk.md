...
> Fonte: [Chipmunk](https://dwarffortresswiki.org/index.php/Chipmunk) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes chipmunks for their stripes.**
- **Biome**
...
**Chipmunks** are a type of vermin found in temperate forests in all seasons except winter. They can be captured by trappers and turned into pets. All chipmunks possess Legendary skill in climbing.

Some dwarves like chipmunks for their *stripes*.
