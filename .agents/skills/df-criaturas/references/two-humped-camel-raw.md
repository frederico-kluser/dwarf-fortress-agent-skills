# Two-humped camel/raw

> Fonte: [Two-humped camel/raw](https://dwarffortresswiki.org/index.php/Two-humped_camel/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
1 kph[CREATURE:CAMEL_2_HUMP]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:two-humped camel calf:two-humped camel calves]
	[CREATURE_TILE:'C']
	[COLOR:6:0:0]
	...
	[DIURNAL]
	[HOMEOTHERM:10070]
	[GAIT:WALK:Gallop:135:10:3:405:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Canter:270:5:3:405:3:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Trot:405:NO_BUILD_UP:0:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
