...
> Fonte: [Wild boar/raw](https://dwarffortresswiki.org/index.php/Wild_boar/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
TheWanderer[CREATURE:WILD_BOAR]

	[DESCRIPTION:A medium-sized beast, known for its tusks and powerful build.]
	[NAME:wild boar:wild boars:wild boar]
	[CHILD:1]
	[GENERAL_CHILD_NAME:wild boar piglet:wild boar piglets]
	[CREATURE_TILE:'B']
	[COLOR:6:0:0]
