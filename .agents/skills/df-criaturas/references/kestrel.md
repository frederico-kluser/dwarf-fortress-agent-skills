...
> Fonte: [Kestrel](https://dwarffortresswiki.org/index.php/Kestrel) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes kestrels for their hunting prowess.**
- **Biome**
...
Some dwarves like kestrels for their *coloration* and their *hunting prowess*.
