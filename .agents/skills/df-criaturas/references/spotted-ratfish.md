...
> Fonte: [Spotted ratfish](https://dwarffortresswiki.org/index.php/Spotted_ratfish) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes spotted ratfish for their coloration.**
- **Biome**
- **Temperate Ocean**
- **Attributes**
- **Aquatic · Fishable**
...
**Spotted ratfish** are a type of aquatic vermin found only in temperate oceans, and are a ready source of food when cleaned at a fishery.
...
|  |
|----|
| "Spotted ratfish" in other / Languages / Dwarven / : / tangak atem-tatlosh / Elven / : / ase thapa-thaci / Goblin / : / spuspsot spödgôz-otu / Human / : / lurit othur-amsir |
