...
> Fonte: [Pixie](https://dwarffortresswiki.org/index.php/Pixie) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes pixies for their shifting colors.**
- **Biome**
- **Almost Anywhere**
- **Attributes**
- **Alignment:** Good
...
Some dwarves like pixies for their *shifting colors* and their *intricate aerial dances*.
