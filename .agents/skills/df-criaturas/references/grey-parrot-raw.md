...
> Fonte: [Grey parrot/raw](https://dwarffortresswiki.org/index.php/Grey_parrot/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Rainseeker's bird Maggie[CREATURE:BIRD_PARROT_GREY]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:grey parrot chick:grey parrot chicks]
	[CREATURE_TILE:'p']
	[COLOR:7:0:0]
	[NATURAL]
	[LARGE_ROAMING]
