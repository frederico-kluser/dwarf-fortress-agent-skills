...
> Fonte: [Barn owl/raw](https://dwarffortresswiki.org/index.php/Barn_owl/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Glaucus - "Only when the dusk starts to fall does the owl of Minerva spread its wings and fly."[CREATURE:BIRD_OWL_BARN]
