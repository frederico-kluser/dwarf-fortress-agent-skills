...
> Fonte: [Rattlesnake man/raw](https://dwarffortresswiki.org/index.php/Rattlesnake_man/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[CREATURE:RATTLESNAKE_MAN]
	...
	[USE_MATERIAL_TEMPLATE:VENOM:CREATURE_EXTRACT_TEMPLATE]
		...
		[SYNDROME]
			...
			[SYN_IMMUNE_CREATURE:RATTLESNAKE_MAN:ALL]
			[SYN_INJECTED]
