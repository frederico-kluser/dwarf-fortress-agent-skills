...
> Fonte: [Swan/raw](https://dwarffortresswiki.org/index.php/Swan/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
IL[CREATURE:BIRD_SWAN]

	[DESCRIPTION:A small aquatic bird, prized for its beauty.]
	[NAME:swan:swans:swan]
	[CHILD:1]
	[GENERAL_CHILD_NAME:cygnet:cygnets]
	[CREATURE_TILE:'s']
	[COLOR:7:0:1]
	[NATURAL]
	[LARGE_ROAMING]
