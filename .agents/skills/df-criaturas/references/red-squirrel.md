...
> Fonte: [Red squirrel](https://dwarffortresswiki.org/index.php/Red_squirrel) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes red squirrels for their tails.**
- **Biome**
...
**Red squirrels** are a type of above ground vermin found in any temperate forest, but will not be seen during winter. They can be captured by trappers and turned into pets.

Some dwarves like red squirrels for their *tails*.
