...
> Fonte: [Giant platypus/raw](https://dwarffortresswiki.org/index.php/Giant_platypus/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[CREATURE:PLATYPUS, GIANT]
	...
	[USE_MATERIAL_TEMPLATE:VENOM:CREATURE_EXTRACT_TEMPLATE]
		...
		[SYNDROME]
			...
			[SYN_IMMUNE_CREATURE:PLATYPUS, GIANT:ALL]
			[SYN_INJECTED]
