...
> Fonte: [Intelligent undead](https://dwarffortresswiki.org/index.php/Intelligent_undead) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

**Intelligent undead** `Ñ` (also known as **raised undead** in-game) is a generalized name for all undead night creatures that are sentient (not zombies), yet don’t fit into the molds for vampires, necromancers, ghosts or mummies.
...
|  | **Blind** | The undead deprives its victim of sight temporarily, making them appear as if blind. In adventurer mode, it appears to have a typo, giving the message "You your sight is fading!"Bug:11858 Creatures with [`[EXTRAVISION]`](/index.php/Creature_token#EXTRAVISION "Creature token") are immune to this power. |
...
|  | **Vanish** | The undead immediately enters stealth, becoming invisible. Players are unable to retaliate, block, or dodge against the undead's attacks, due to not being able to target them, but may hit them with thrown items. Creatures with [`[EXTRAVISION]`](/index.php/Creature_token#EXTRAVISION "Creature token") can see the undead normally, negating the power. |
...
Intelligent undead do not need to eat, drink, or sleep and can function normally despite very severe damage, such as a brain and skull "mangled beyond recognition", providing excellent practice for your medical dwarves. They do not age, reproduce, or gain or rust physical attributes (but do still gain or rust skills), and count as [`[NOT_LIVING]`](/index.php/Creature_token#NOT_LIVING "Creature token"), so other undead will be neutral to them. They also have many of the immunities undead have, such as [`[NOEXERT]`](/index.php/Creature_token#NOEXERT "Creature token"), [`[NOPAIN]`](/index.php/Creature_token#NOPAIN "Creature token"), [`[NOBREATHE]`](/index.php/Creature_token#NOBREATHE "Creature token"), [`[NOSTUN]`](/index.php/Creature_token#NOSTUN "Creature token"), [`[NONAUSEA]`](/index.php/Creature_token#NONAUSEA "Creature token"), [`[NO_DIZZINESS]`](/index.php/Creature_token#NO_DIZZINESS "Creature token"), [`[NO_FEVERS]`](/index.php/Creature_token#NO_FEVERS "Creature token"), [`[PARALYZEIMMUNE]`](/index.php/Creature_token#PARALYZEIMMUNE "Creature token"), [`[NOFEAR]`](/index.php/Creature_token#NOFEAR "Creature token"), [`[NO_THOUGHT_CENTER_FOR_MOVEMENT]`](/index.php/Creature_token#NO_THOUGHT_CENTER_FOR_MOVEMENT "Creature token"), [`[NO_CONNECTIONS_FOR_MOVEMENT]`](/index.php/Creature_token#NO_CONNECTIONS_FOR_MOVEMENT "Creature token") and [`[EXTRAVISION]`](/index.php/Creature_token#EXTRAVISION "Creature token"). They also cannot bleed to death. This, in addition to the magical powers granted to them when they were raised, makes them very useful assets to your fortress. Lastly, as a consequence of them not aging, any intelligent undead child will remain a child for eternity (even after becoming 18 years old, the in-game trigger will not remove the Child token)

Like all undead, intelligent undead dwarves cannot enter trances anymore, and intelligent undead gremlins are no longer [`[MISCHIEVOUS]`](/index.php/Creature_token#MISCHIEVOUS "Creature token").
...
- Zombie
    ...
    Example raws (as extracted from world.sav in version
    51.13
    )

    [INTERACTION:SECRET_UNDEAD_RES_1]
        [GENERATED]
        [I_TARGET:A:CORPSE]
