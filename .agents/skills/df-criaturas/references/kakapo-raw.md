...
> Fonte: [Kakapo/raw](https://dwarffortresswiki.org/index.php/Kakapo/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
You've just been shagged by a rare parrot![CREATURE:BIRD_KAKAPO]
	...
	[CHILD:7]
	[GENERAL_CHILD_NAME:kakapo chick:kakapo chicks]
	[CREATURE_TILE:'k']
	[COLOR:2:0:0]
	[NATURAL]
	[LARGE_ROAMING]
