...
> Fonte: [White stork/raw](https://dwarffortresswiki.org/index.php/White_stork/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
"From Alsace, with love."[CREATURE:BIRD_STORK_WHITE]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:white stork hatchling:white stork hatchlings]
	[CREATURE_TILE:'s']
	[COLOR:7:0:1]
	[NATURAL]
	[LARGE_ROAMING]
