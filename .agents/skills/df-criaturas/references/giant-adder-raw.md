...
> Fonte: [Giant adder/raw](https://dwarffortresswiki.org/index.php/Giant_adder/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[CREATURE:GIANT_ADDER]
	...
	[USE_MATERIAL_TEMPLATE:VENOM:CREATURE_EXTRACT_TEMPLATE]
		...
		[SYNDROME]
			...
			[SYN_IMMUNE_CREATURE:GIANT_ADDER:ALL]
			[SYN_INJECTED]
