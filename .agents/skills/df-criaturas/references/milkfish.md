...
> Fonte: [Milkfish](https://dwarffortresswiki.org/index.php/Milkfish) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes milkfish for their silvery bodies.**
- **Biome**
...
\
Despite their name, milkfish can not be milked.
