...
> Fonte: [Lion tamarin](https://dwarffortresswiki.org/index.php/Lion_tamarin) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes lion tamarins for their manes.**
- **Biome**
...
**Lion tamarins** are a species of above ground vermin found exclusively in tropical moist broadleaf forests. They can be caught in animal traps and tamed into pets, but other than that, they are generally unremarkable. Their most notable trait is being the only species of vermin based on a primate, while all others in the game are considered full-fledged creatures. All lion tamarins possess Legendary skill in climbing.

Some dwarves like lion tamarins for their *small size* and their *manes*.
