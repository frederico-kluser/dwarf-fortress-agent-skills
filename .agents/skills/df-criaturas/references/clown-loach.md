...
> Fonte: [Clown loach](https://dwarffortresswiki.org/index.php/Clown_loach) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes clown loaches for their coloration.**
- **Biome**
...
**Clown loaches** are a type of aquatic vermin found year-round in tropical freshwater rivers and lakes, and are a ready source of food when cleaned at a fishery.

Some dwarves like clown loaches for their *coloration*.
