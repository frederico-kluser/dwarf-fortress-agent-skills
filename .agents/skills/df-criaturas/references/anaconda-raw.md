...
> Fonte: [Anaconda/raw](https://dwarffortresswiki.org/index.php/Anaconda/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Jayson French - "May these creatures be blessed with the alacrity and lethality of the mighty carp."[CREATURE:ANACONDA]
