...
> Fonte: [Guppy](https://dwarffortresswiki.org/index.php/Guppy) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes guppies for their coloration.**
- **Biome**
- **Tropical Freshwater River Tropical Brackish River Tropical Saltwater River Tropical Freshwater Lake Tropical Brackish Lake Tropical Saltwater Lake**
- **Attributes**
- **Aquatic · Fishable**
- **Active Seasons**
...
**Guppies** are a type of aquatic vermin found in tropical rivers and lakes year-round, and are a ready source of food when cleaned at a fishery.

Some dwarves like guppies for their *coloration*.
