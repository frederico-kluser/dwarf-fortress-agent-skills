...
> Fonte: [Brown bullhead](https://dwarffortresswiki.org/index.php/Brown_bullhead) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes brown bullheads for their whiskers.**
- **Biome**
...
**Brown bullheads** are an aquatic vermin. They are found only in temperate freshwater lakes, but can be seen year-round, and are a ready source of food when cleaned at a fishery.

Some dwarves like brown bullheads for their *whiskers*.
