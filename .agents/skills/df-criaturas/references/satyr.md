...
> Fonte: [Satyr](https://dwarffortresswiki.org/index.php/Satyr) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes satyrs for their woolly legs.**
- **Biome**
- **Temperate Broadleaf Forest Tropical Coniferous Forest Tropical Dry Broadleaf Forest**
- **Attributes**
- **Alignment:** Good
- **Learns · Fanciful · Horn · Horn · Humanoid**
- **Cannot be tamed**
- **Size**
- **Birth:** 6,000 cm 3
- **Mid:** 30,000 cm 3
...
Some dwarves like satyrs for their *woolly legs*.
