...
> Fonte: [Penguin/raw](https://dwarffortresswiki.org/index.php/Penguin/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Theq629[CREATURE:BIRD_PENGUIN]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:penguin chick:penguin chicks]
	[CREATURE_TILE:'p']
	[COLOR:0:0:1]
	[NATURAL]
	[LARGE_ROAMING]
