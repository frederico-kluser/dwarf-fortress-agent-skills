...
> Fonte: [Bobcat/raw](https://dwarffortresswiki.org/index.php/Bobcat/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
MarineMorton[CREATURE:BOBCAT]

	[DESCRIPTION:A small feline predator with a shortened tail.]
	[NAME:bobcat:bobcats:bobcat]
	[CASTE_NAME:bobcat:bobcats:bobcat]
	[CHILD:3]
	[GENERAL_CHILD_NAME:bobcat kitten:bobcat kittens]
	[CREATURE_TILE:'b']
	[COLOR:6:0:0]
	...
	[CREPUSCULAR]
	[HOMEOTHERM:10067]
	[GAIT:WALK:Gallop:266:10:3:699:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Canter:497:5:3:699:3:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Trot:699:NO_BUILD_UP:0:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
