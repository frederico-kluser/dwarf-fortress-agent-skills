...
> Fonte: [Jaguar/raw](https://dwarffortresswiki.org/index.php/Jaguar/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
1 kph[CREATURE:JAGUAR]
	...
	[CHILD:3]
	[GENERAL_CHILD_NAME:jaguar cub:jaguar cubs]
	[CREATURE_TILE:'J']
	[COLOR:6:0:1]
