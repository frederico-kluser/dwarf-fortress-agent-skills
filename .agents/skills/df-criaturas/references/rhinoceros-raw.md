...
> Fonte: [Rhinoceros/raw](https://dwarffortresswiki.org/index.php/Rhinoceros/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
5 kph[CREATURE:RHINOCEROS]
	...
	[CHILD:10]
	[GENERAL_CHILD_NAME:rhinoceros calf:rhinoceros calves]
	[CREATURE_TILE:'R']
	[COLOR:7:0:0]
