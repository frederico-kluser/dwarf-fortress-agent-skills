...
> Fonte: [Impala/raw](https://dwarffortresswiki.org/index.php/Impala/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Impalas were sponsored by the generous contributions of the Bay 12 community.[CREATURE:IMPALA]

	[DESCRIPTION:A small, slender gazelle-like creature.]
	[NAME:impala:impalas:impala]
	[CASTE_NAME:impala:impalas:impala]
	[CHILD:1]
	[GENERAL_CHILD_NAME:impala fawn:impala fawns]
	[CREATURE_TILE:'i']
	[COLOR:6:0:0]
	...
	[DIURNAL]
	[HOMEOTHERM:10067]
	[GAIT:WALK:Gallop:146:10:3:438:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Canter:292:5:3:438:3:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Trot:438:NO_BUILD_UP:0:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
