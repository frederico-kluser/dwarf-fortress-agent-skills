...
> Fonte: [Chinchilla/raw](https://dwarffortresswiki.org/index.php/Chinchilla/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Chinchillas were sponsored by the generous contributions of the Bay 12 community.[CREATURE:CHINCHILLA]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:chinchilla kit:chinchilla kits]
	[CREATURE_TILE:'c']
	[COLOR:7:0:0]
