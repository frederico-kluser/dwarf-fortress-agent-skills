...
> Fonte: [Rainbow trout](https://dwarffortresswiki.org/index.php/Rainbow_trout) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes rainbow trout for their coloration.**
- **Biome**
- **Temperate Freshwater River Temperate Freshwater Lake**
- **Attributes**
- **Aquatic · Fishable**
- **Active Seasons**
...
**Rainbow trout** are a type of aquatic vermin found in temperate freshwater rivers and lakes year-round. They are a ready source of food when cleaned at a fishery.

Some dwarves like rainbow trout for their *coloration*.
