...
> Fonte: [Adder man/raw](https://dwarffortresswiki.org/index.php/Adder_man/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[CREATURE:ADDER_MAN]
	...
	[USE_MATERIAL_TEMPLATE:VENOM:CREATURE_EXTRACT_TEMPLATE]
		...
		[SYNDROME]
			...
			[SYN_IMMUNE_CREATURE:ADDER_MAN:ALL]
			[SYN_INJECTED]
