...
> Fonte: [Parakeet](https://dwarffortresswiki.org/index.php/Parakeet) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes parakeets for their ability to speak.**
- **Biome**
...
**Parakeets** are a species of above ground vermin, found in a number of tropical biomes. They may be captured in animal traps and turned into pets. All parakeets possess Legendary skill in climbing.

Some dwarves like parakeets for their *coloration* and their *ability to speak* (but they have no actual CAN_SPEAK token).
