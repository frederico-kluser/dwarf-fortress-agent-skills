...
> Fonte: [Giant tortoise/raw](https://dwarffortresswiki.org/index.php/Giant_tortoise/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Ves - They were so edible.[CREATURE:GIANT TORTOISE]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:giant tortoise hatchling:giant tortoise hatchlings]
	[CREATURE_TILE:'T']
	[COLOR:6:0:0]
	[PETVALUE:50]
	[BENIGN]
 ...
 shell]
	[DIURNAL]
	[GAIT:WALK:Scramble:1097:10:3:4026:50:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Faster Crawl:3327:5:3:4026:10:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Fast Crawl:4026:NO_BUILD_UP:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
	[GAIT:WALK:Crawl:4732:NO_BUILD_UP:0]
	[GAIT:WALK:Slow Crawl:5922:NO_BUILD_UP:0]
