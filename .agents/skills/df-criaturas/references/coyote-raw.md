...
> Fonte: [Coyote/raw](https://dwarffortresswiki.org/index.php/Coyote/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
"The Trickster can find his way into anything, the hard part is getting out!"[CREATURE:COYOTE]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:coyote pup:coyote pups]
	[CREATURE_TILE:'c']
	[COLOR:7:0:0]
