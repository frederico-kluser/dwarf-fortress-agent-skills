...
> Fonte: [Giraffe/raw](https://dwarffortresswiki.org/index.php/Giraffe/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
1 kph[CREATURE:GIRAFFE]
	...
	[CHILD:10]
	[GENERAL_CHILD_NAME:giraffe calf:giraffe calves]
	[CREATURE_TILE:'G']
	[COLOR:6:0:0]
