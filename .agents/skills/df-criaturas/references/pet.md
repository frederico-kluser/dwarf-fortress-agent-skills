...
|  |
|----|
| "Pet" in other / Languages / Dwarven / : / bab / Elven / : / querete / Goblin / : / amro / Human / : / pathril |
...
For a specific animal, you can also use the u Units menu, under "Pets/Livestock". Click on  near specific animal to zoom to that pet's location and automatically view the details of that creature. At the top of the general information screen (which is the default) are listed the creature's name, the translation of that name, and, if owned, it will state *"Pet of "*. If no owner is listed\*, then it is unclaimed.
...
Some animals, especially poultry, root around, which can attract vermin. This makes them bad as pets that follow your dwarves around. They can still be pastured, which prevents them from wandering around your fort, and both the positive and negative effects of a pet, until the pet dies.
...
*Main article: Mount#Adventure mode*

Adventurers can buy pets during character creation, or claim stray animals. Pets follow their owner while exploring the world.

To claim a stray animal, walk up to it and press h, then choose to claim it in the menu - this action always succeeds. Pets can be gifted to other people as a conversation option, listed as "Gift a (large) pet or mount (new menu)".

Using necromancy to reanimate a corpse will also claim the resulting undead creature as a pet.

### Combat

Pets will join their owner's conflicts - as animals don't have access to non-lethal combat, fighting alongside an animal will escalate the fight to Lethal. Hunting and war trained animals can be bought during character creation, improving their sight range or attacks respectively.

### Utility

Provided the creature has the requisite abilities ([`[MOUNT]`](/index.php/Creature_token#MOUNT "Creature token")/[`[MOUNT_EXOTIC]`](/index.php/Creature_token#MOUNT_EXOTIC "Creature token") or [`[PACK_ANIMAL]`](/index.php/Creature_token#PACK_ANIMAL "Creature token") respectively), pets can be ridden or used to store items.
