...
> Fonte: [Tapir/raw](https://dwarffortresswiki.org/index.php/Tapir/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Samthere - Release the war tapirs![CREATURE:TAPIR]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:tapir calf:tapir calves]
	[CREATURE_TILE:'T']
	[COLOR:7:0:1]
	...
	[CREPUSCULAR]
	[HOMEOTHERM:10068]
	[GAIT:WALK:Gallop:274:10:3:703:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Canter:505:5:3:703:3:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Trot:703:NO_BUILD_UP:0:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
