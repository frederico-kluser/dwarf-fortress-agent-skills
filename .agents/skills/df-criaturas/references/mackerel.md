...
> Fonte: [Mackerel](https://dwarffortresswiki.org/index.php/Mackerel) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
**Mackerel** are a type of aquatic vermin found in temperate and arctic oceans year-round, and are a ready source of food when cleaned at a fishery.

Some dwarves like mackerel for their *stripes*.
