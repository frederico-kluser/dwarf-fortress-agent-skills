...
> Fonte: [Dog](https://dwarffortresswiki.org/index.php/Dog) — Dwarf Fortress Wiki (GFDL/MIT)
...
You can assign a war dog or hunting dog to a dwarf via his preferences menu (, select dwarf, , ) to help him in combat. It will follow the dwarf like a pet.
