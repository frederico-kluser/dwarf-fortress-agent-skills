...
> Fonte: [Raccoon man/raw](https://dwarffortresswiki.org/index.php/Raccoon_man/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
>[CREATURE:RACCOON_MAN]

	[NAME:raccoon man:raccoon men:raccoon man]
	[DESCRIPTION:A person with the mask and tail of a raccoon.]
	...
	[GRASSTRAMPLE:0]
	[PREFSTRING:mischief]
	[BODY:HUMANOID_NECK:3FINGERS:TAIL:2EYES:2EARS:NOSE:2LUNGS:HEART:GUTS:ORGANS:THROAT:NECK:SPINE:BRAIN:SKULL:5FINGERS:5TOES:MOUTH:TONGUE:GENERIC_TEETH_WITH_LARGE_EYE_TEETH:RIBCAGE]
	[BODYGLOSS:PAW]
	...
	[CAN_DO_INTERACTION:PET_ANIMAL]
		...
		[CDI:WAIT_PERIOD:20]
	[SELECT_CASTE:MALE]
		[CASTE_NAME:raccoon man:raccoon men:raccoon man]
	[SELECT_CASTE:FEMALE]
		[CASTE_NAME:raccoon woman:raccoon women:raccoon woman]
	[SELECT_CASTE:ALL]
