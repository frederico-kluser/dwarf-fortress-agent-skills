...
> Fonte: [Kiwi/raw](https://dwarffortresswiki.org/index.php/Kiwi/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Gregory Kampjes, McLovin[CREATURE:BIRD_KIWI]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:kiwi chick:kiwi chicks]
	[CREATURE_TILE:'k']
	[COLOR:6:0:0]
