...
> Fonte: [Wolverine/raw](https://dwarffortresswiki.org/index.php/Wolverine/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Doug Treder and sons[CREATURE:WOLVERINE]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:wolverine kit:wolverine kits]
	[CREATURE_TILE:'w']
	[COLOR:6:0:0]
