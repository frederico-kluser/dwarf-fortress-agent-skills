# Red-winged blackbird/raw

> Fonte: [Red-winged blackbird/raw](https://dwarffortresswiki.org/index.php/Red-winged_blackbird/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
12 kph[CREATURE:BIRD_RW_BLACKBIRD]
