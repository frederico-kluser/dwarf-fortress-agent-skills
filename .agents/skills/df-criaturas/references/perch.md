...
> Fonte: [Perch](https://dwarffortresswiki.org/index.php/Perch) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes perch for their coloration.**
- **Biome**
...
**Perch** are a type of aquatic vermin found in temperate freshwater rivers and lakes year-round. They are a ready source of food when cleaned at a fishery.

Some dwarves like perch for their *coloration*.
