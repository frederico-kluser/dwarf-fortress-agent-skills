...
> Fonte: [Coelacanth](https://dwarffortresswiki.org/index.php/Coelacanth) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes coelacanths for their coloration.**
- **Biome**
- **Tropical Ocean**
- **Attributes**
- **Aquatic**
