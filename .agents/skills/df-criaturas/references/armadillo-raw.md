...
> Fonte: [Armadillo/raw](https://dwarffortresswiki.org/index.php/Armadillo/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Enkufka[CREATURE:ARMADILLO]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:armadillo pup:armadillo pups]
	[CREATURE_TILE:'a']
	[COLOR:7:0:0]
