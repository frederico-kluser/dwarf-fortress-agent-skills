...
> Fonte: [Black bullhead](https://dwarffortresswiki.org/index.php/Black_bullhead) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes black bullheads for their whiskers.**
- **Biome**
...
**Black bullheads** are an aquatic vermin found year-round in temperate freshwater lakes, and are a ready source of food when cleaned at a fishery.

Some dwarves like black bullheads for their *whiskers*.
