...
> Fonte: [Angel](https://dwarffortresswiki.org/index.php/Angel) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
|  |
|----|
| "Angel" in other / Languages / Dwarven / : / sedil / Elven / : / thili / Goblin / : / asmuk / Human / : / idla |

Dwarves will never have a preference for angels, as they possess no [`[PREFSTRING]`](/index.php/Creature_token#PREFSTRING "Creature token"). They possess an unused pet value of 2,000. Like other procedurally-generated creatures, they are not available to be spawned in the object testing arena.
...
In the world raws, the divine language is referred to as GEN_DIVINE. By changing an entity's [`[TRANSLATION]`](/index.php/Entity_token#TRANSLATION "Entity token") to GEN_DIVINE, it's possible to make them use the same names as the angels.
