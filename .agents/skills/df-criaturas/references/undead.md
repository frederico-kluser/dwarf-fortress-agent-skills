...
> Fonte: [Undead](https://dwarffortresswiki.org/index.php/Undead) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
A mummy raising undead from a tomb.
...
- Unliving, sterile and opposed to life. Will be hostile to everything in the vicinity, other than fellow undead and inorganic aberrations that also have [`[NOT_LIVING]`](/index.php/Creature_token#NOT_LIVING "Creature token") (iron men, bronze colossuses).
...
Undead from necromancer towers "Tower (necromancy)") are reported to carry *armor and weapons*, giving the terror of the announcement *"The dead walk! Hide while you can!"* far more weight than before.
...
A drawing of a zombie and a dwarf by Zach Adams. All craftsdwarfship is of the highest quality. The dwarf is stabbing the zombie in the back. The zombie is smirking.
...
The undead are not to be trifled with – they have high Strength and very high Toughness, along with all other physical attributes increased (except Speed), do not tire, feel no pain, have no useful articulations to damage, ignore injuries to their now-useless organs, do not fall unconscious, and are impervious to the effects of morale. Add in that they often arrive in very large numbers, using armor and weapons which make them even more powerful, and with necromancers to reanimate them, and that the greatest of beasts can be reanimated, and it comes off as no surprise that the undead can pose a great opportunity for trouble.
...
- Undead will not attack inorganic/elemental creatures, such as gabbro men and bronze colossuses. This is because these creatures are also treated as 'non-living', despite the fact they are not undead.
...
|  |
|----|
| "Undead" in other / Languages / Dwarven / : / nasnökor / Elven / : / senoanaÿa / Goblin / : / rotûstru / Human / : / obmuthro |
