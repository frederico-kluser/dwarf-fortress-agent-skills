...
> Fonte: [Lynx/raw](https://dwarffortresswiki.org/index.php/Lynx/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
When you simply can't have a lobster -- veok, the Lobster Rage Fist[CREATURE:LYNX]
	...
	[CHILD:3]
	[GENERAL_CHILD_NAME:lynx cub:lynx cubs]
	[CREATURE_TILE:'l']
	[COLOR:6:0:0]
