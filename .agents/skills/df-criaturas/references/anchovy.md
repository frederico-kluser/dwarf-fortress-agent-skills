...
> Fonte: [Anchovy](https://dwarffortresswiki.org/index.php/Anchovy) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes anchovies for their distinct snout.**
- **Biome**
- **Temperate Ocean**
- **Attributes**
- **Aquatic · Fishable**
...
**Anchovies** are a type of aquatic vermin found in temperate oceans year-round, and are a ready source of food when cleaned at a fishery.

Some dwarves like anchovies for their *distinct snout*.
