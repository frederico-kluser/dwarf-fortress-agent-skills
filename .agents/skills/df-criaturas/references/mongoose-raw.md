...
> Fonte: [Mongoose/raw](https://dwarffortresswiki.org/index.php/Mongoose/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
DevHyfes - Should this journey lead to death, we ride together![CREATURE:MONGOOSE]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:mongoose pup:mongoose pups]
	[CREATURE_TILE:'m']
	[COLOR:7:0:0]
	...
	[DIURNAL]
	[HOMEOTHERM:10067]
	[GAIT:WALK:Gallop:151:10:3:453:5:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:50]
	[GAIT:WALK:Canter:302:5:3:453:3:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:20]
	[GAIT:WALK:Trot:453:NO_BUILD_UP:0:LAYERS_SLOW:STRENGTH:AGILITY:STEALTH_SLOWS:10]
