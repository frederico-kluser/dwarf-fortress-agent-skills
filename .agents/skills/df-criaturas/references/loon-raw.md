...
> Fonte: [Loon/raw](https://dwarffortresswiki.org/index.php/Loon/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
Sponsored by Klokwurk. You can't get better than awesome![CREATURE:BIRD_LOON]
	...
	[CHILD:1]
	[GENERAL_CHILD_NAME:loon chick:loon chicks]
	[CREATURE_TILE:'l']
	[COLOR:0:0:1]
	[NATURAL]
	[LARGE_ROAMING]
