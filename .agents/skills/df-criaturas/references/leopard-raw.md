...
> Fonte: [Leopard/raw](https://dwarffortresswiki.org/index.php/Leopard/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

```
1 kph[CREATURE:LEOPARD]
	...
	[CHILD:3]
	[GENERAL_CHILD_NAME:leopard cub:leopard cubs]
	[CREATURE_TILE:'l']
	[COLOR:6:0:1]
