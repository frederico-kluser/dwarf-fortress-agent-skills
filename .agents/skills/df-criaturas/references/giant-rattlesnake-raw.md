...
> Fonte: [Giant rattlesnake/raw](https://dwarffortresswiki.org/index.php/Giant_rattlesnake/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[CREATURE:GIANT_RATTLESNAKE]
	...
	[USE_MATERIAL_TEMPLATE:VENOM:CREATURE_EXTRACT_TEMPLATE]
		...
		[SYNDROME]
			...
			[SYN_IMMUNE_CREATURE:GIANT_RATTLESNAKE:ALL]
			[SYN_INJECTED]
