...
> Fonte: [Sole](https://dwarffortresswiki.org/index.php/Sole) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes sole for their flat bodies.**
- **Biome**
...
**Sole** are a type of aquatic vermin found in temperate and arctic oceans year-round, and are a ready source of food when cleaned at a fishery.

Some dwarves like sole for their *flat bodies*.
