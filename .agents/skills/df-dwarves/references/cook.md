...
> Fonte: [Cook](https://dwarffortresswiki.org/index.php/Cook) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
Prepare Easy Meal / Prepare Fine Meal / Prepare Lavish Meal / Render Fat
...
|  |
|----|
| "Cook" in other / Languages / Dwarven / : / rafar / Elven / : / othi / Goblin / : / kengku / Human / : / lem |
...
Prepared meals get a quality modifier on their base value and each individual ingredient also gets a quality modifier as well, but more ingredients reduces the value of each. See Item value for more information.
...
When rendering large units of fat (for example from elephants or forgotten beasts) a dwarf gains cooking skill extremely quickly due to the dozens or hundreds of units of tallow created per task - even to the point of going from dabbling to skilled in a single task.\[Verify\] Thus, rendering fat can be used to rapidly train cooking to high levels.
...
Many of the monsters are surprisingly edible, therefore a skilled cook is all you need the next time your adventuring party needs to save someone from a dragon.
