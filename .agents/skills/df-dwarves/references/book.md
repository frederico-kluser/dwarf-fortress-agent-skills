...
Adventurers can read books in their possession by pressing I then selecting them from their inventory. Characters must possess at least novice-level Reader skill in order to read a book - unfortunately, the skill can **only** be leveled up in-game by reading books, which is impossible to do without any reader skill to begin with. Raising the reader skill in advance during character creation (or simply adding some amount of [`[NATURAL_SKILL]`](/index.php/Creature_token#NATURAL_SKILL "Creature token") to one's chosen race in the raws) is therefore crucial.
...
Books containing "secrets of life and death" are occasionally written during world generation by necromancers and various demonic rulers. Any mortal creature who reads one will immediately learn the secrets to immortality and the ability to raise the dead. Necromancy books can be found in a necromancer's tower "Tower (necromancy)") among other types of books, including the original slab which the secrets originated from.
...
[`[NAME]`](/index.php/Speech_file#NAME "Speech file") and [`[NO_ART_NAME]`](/index.php/Speech_file#NO_ART_NAME "Speech file") are not handled separately in this case. `[NO_ART_NAME] Inside [NAME]` will result in "Tower Inside The Tower"
...
[`[NAME]`](/index.php/Speech_file#NAME "Speech file")
...
\
[`[NO_ART_NAME]`](/index.php/Speech_file#NO_ART_NAME "Speech file") (no article name)
...
\
[`[NOUN]`](/index.php/Speech_file#NOUN "Speech file")
...
\
[`[ADJ]`](/index.php/Speech_file#ADJ "Speech file")
...
\
[`[ANY_AGE]`](/index.php/Speech_file#ANY_AGE "Speech file")
...
\
[`[ANY_PRONOUN]`](/index.php/Speech_file#ANY_PRONOUN "Speech file")
...
\
[`[PHRASE]`](/index.php/Speech_file#PHRASE "Speech file")
...
|  |
|----|
| "Book" in other / Languages / Dwarven / : / thîkut / Elven / : / soya / Goblin / : / zosto / Human / : / thothil |
