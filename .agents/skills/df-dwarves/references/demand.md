...
> Fonte: [Demand](https://dwarffortresswiki.org/index.php/Demand) — Dwarf Fortress Wiki (GFDL/MIT)
...
- Nobles might demand items that cannot be produced (a steel bed for example). Workarounds include decorating a normal piece of furniture with the demanded material, just accept that the noble will receive a negative thought, or hope that one of your dwarves has produced what they want in a strange mood.
