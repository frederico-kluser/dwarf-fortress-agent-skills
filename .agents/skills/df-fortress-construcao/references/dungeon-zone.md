...
> Fonte: [Dungeon (zone)](https://dwarffortresswiki.org/index.php/Dungeon_(zone)) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

A **dungeon**, also known as a **prison**, its rooms known as **jails**\[Verify "Talk:Dungeon (zone)")\], is a zone used by the justice system within your dwarven community. They are designated from z Zones menu by selecting  Dungeon option.
...
- Chains, on the other hand, allow the dwarf to wander around in the adjacent tiles, potentially giving them access to food, alcohol, and nice furniture to boost happiness. However, a dwarf throwing a tantrum can potentially **destroy** its chain and escape to cause further damage to your fortress; furthermore, having justice-designated chains opens the possibility of dwarves being sentenced to hammerstrikes.

You can check how many cages and restraints the game expects you to have inside a dungeon zone in the "Fortress guard" tab of the j Justice menu.
...
- A small stockpile of good food, such as prepared meals, lets the prisoner eat when they're hungry, instead of when your haulers are free to feed them, and lets you provide high-quality stuff instead of whatever random item the haulers grab. You won't need barrels for this stockpile, so turn 'em off ( in the stockpile menu).
...
- A dwarf can view artifacts on pedestals, so place a few pedestals with artifacts near the chain so the dwarf can view them for happy art thoughts.
- A dwarf can admire its own restraint, so try a high-quality bone and jewel-encrusted steel or platinum chain.
- Adding a well to each dungeon cell guarantees that your prisoners will never die of thirst, if your ~~free dwarves~~ prison guards are a bit slow restocking their booze. And making the well from high-quality materials allows them to admire it, too!
...
|  |
|----|
| "Dungeon (zone)" in other / Languages / Dwarven / : / teskom / Elven / : / lezitha / Goblin / : / ax / Human / : / cudal |
