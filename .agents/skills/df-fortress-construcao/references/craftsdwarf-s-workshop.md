...
> Fonte: [Craftsdwarf's workshop](https://dwarffortresswiki.org/index.php/Craftsdwarf's_workshop) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
- **Construction**
- **Materials:** Labors
- **Building material (non- economic ):** 1 of Bone carving Stonecrafting Woodcrafting
- **Materials Used**
- **Stone Wood Bone Shell Ivory Tooth Horn Pearl Cloth Thread Wax Leather Skull**
- **Goods Created**
- **Rock Crafts , Mugs , Instruments , Toys , Jugs , Large Pots , Hives , and Nest Boxes Wood, Plant Fiber Cloth, Silk, Shell, Ivory, Tooth, Horn, Pearl, Bone and, Leather Crafts Rock Short Swords Wooden and Bone Bolts Bone, Shell, Ivory, Tooth, Horn, and Pearl Decorations Totems Bone Leggings , Greaves , Gauntlets , and Helms Shell Leggings , Gauntlets , and Helms Adamantine Strands Scroll , Quire , and Book Wood and Stone Scroll rollers and Book binding Instruments and instrument pieces**

!!UNKNOWN!!  · xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

The **Craftsdwarf's workshop** is used to make crafts of many different kinds and perform a few specialized jobs. It can be built from any construction material by a dwarf with the Bone Carving, Stonecrafting, or Woodcrafting labors enabled.
...
- The name of this workshop is actually derived from the `[``PROFESSION_NAME``:CRAFTSMAN]` value specified for your fortress's primary race - for example, if you were to use mods to play as humans, this would be called a "Craftsman's Workshop" instead.
...
- Multi-part Instruments can be assembled here (assumed that single-part bone/thread/stone instruments can as well)
