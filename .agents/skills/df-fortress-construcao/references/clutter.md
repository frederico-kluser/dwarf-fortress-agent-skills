...
> Fonte: [Clutter](https://dwarffortresswiki.org/index.php/Clutter) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

!!UNKNOWN!!  · xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

**Clutter** will occur in workshops when they become full of goods that are not hauled away to stockpiles. There is currently no indication when a workshop gets cluttered. The list of items in the workshop screen will show you what items are cluttering the workshop.
...
The amount of clutter generated by a single item is determined by its volume, however, all items generate a maximum of 1200 units of clutter each.

|                |                 |                 |
|----------------|-----------------|-----------------|
| volume         | minimum / items | factor / slower |
...
**Levels of Clutter** {style="margin: 0 auto; text-align: center; border-spacing: 4px"}
...
A still, for example, can eventually get to the rate where dwarves consume booze at the same speed as the cluttered workshops produce it. Wood furnaces similarly will eventually be brought to a point where they produce fuel at the same rate as other workshops consume it.
...
|  |
|----|
| "Clutter" in other / Languages / Dwarven / : / om / Elven / : / ifeta / Goblin / : / ozma / Human / : / rufo |
