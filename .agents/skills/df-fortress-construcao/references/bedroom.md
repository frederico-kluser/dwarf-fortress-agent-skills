...
> Fonte: [Bedroom](https://dwarffortresswiki.org/index.php/Bedroom) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
A useful bedroom consists of a bed placed in a designated bedroom zone. You will need to craft a bed in a carpenter's workshop, then bfb to build it. Dwarves will not sleep in beds which have been produced in a workshop until they are placed via the build menu. You can designate a bedroom from the zone menu before or after building the bed. If you build the beds first, however, you can use the nifty Multi option to auto-designate individual bedrooms from a large selected area, each room must contain a bed and enclosed with a door.

To remove a bedroom, enter zone mode and select it, then click "Remove this zone permanently" ().
...
Depending on the zone value, bedrooms get a rank:
...
|  |
|----|
| "Bedroom" in other / Languages / Dwarven / : / zust-mosus / Elven / : / sira-imira / Goblin / : / zozax-xustxu / Human / : / ina-coni |
