...
> Fonte: [Combat drills](https://dwarffortresswiki.org/index.php/Combat_drills) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

!!UNKNOWN!!  · xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

Dwarves that are part of a squad that is not currently ordered into "combat mode" (*kill {monster}/station {location}*) will "Train" when they have nothing else to do. If there is no one else to train with a Dwarf will initiate an "Individual Combat Drill". (Soldiers with "self-motivated" in their personality will often initiate Individual Combat Drills when inactive as well.) In order for this to happen you must have either a Barracks (zoned from a bed/cabinet) or an Armory (zoned from a Weapon rack/Armor stand) and set it to "train" mode (using t).
...
Successful sparring will generate combat log reports, showing the S flag in main view for new sparring reports (similar to hunting reports).
...
|  |
|----|
| "Combat drills" in other / Languages / Dwarven / : / zoluth thosbut / Elven / : / moÿira ecefe / Goblin / : / nur ruspzuz / Human / : / thec arat |
