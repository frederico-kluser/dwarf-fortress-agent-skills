...
> Fonte: [Danger room](https://dwarffortresswiki.org/index.php/Danger_room) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

!!UNKNOWN!!  · xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

- In previous versions, a **danger room** was a useful workaround (or exploit?) for regular military training being too slow and difficult for new players to figure out. However, recent modifications to the combat system have made (most?) danger room designs *far* more dangerous, and training via barracks significantly more effective, so small-group sparring is currently the recommended training regimen.

A **danger room** is (was?) a term used to describe a place constructed to train your dwarves in military skills via an active but not-too-dangerous environment, such as being continually poked by wooden training spears, or having very lightweight items thrown at them via a bridge. This serves two purposes: first, it trains your dwarves in combat skills, such as Armor User skill, Shield User, Dodger and to some extent also weapons skills (if they manage to block attacks with them). Second, it helps keep your doctors' skills from rusting (and possibly also keeps your coffin makers busy if not done safely, which is *far* more likely currently).

Some people consider danger rooms an exploit, because they required next to no effort to build your dwarves' combat skills to legendary.Bug:3855

**Warning!**

Danger rooms are now *far more dangerous*, even ***mortally*** so! Changes in the combat damage calculations now change previously ineffective "attacks" into very real blunt-force damage, which can penetrate even layered high-quality steel chain+plate armor. This turns previous minor bumps and bruises into serious tears, breaks and fatalities. For fewer deaths, set up small-group sparring instead.

\
The below designs are preserved in part for historical and nostalgic reasons, but also because some designs may not prove quite as dangerous as others. Use at your own risk.
...
The idea is that as dwarves stand on the trapped tiles, every time the spikes come out of the ground due to the trap being activated, they gain skills in whatever stops it - armor if their armor deflects it, weapon if they block it with their weapon, shield for shield, and dodging if they jump out of the way. Crossbow-armed dwarves gain skill as hammerdwarves, not marksdwarves, because they are using the crossbow as a melee weapon to block. As written here [1], pick-armed dwarves get trained into *legendary miners*.
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|----|
|  | ═ | ═ | ═ | ═ | ═ | ╗ |  |  | % | % |  | S | c | r | e | w |  | p | u | m | p | , |  | p | u | m | p | i | n | g |  | f | r | o | m |  | w | e | s | t |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | ⛭ | % | % | ╟ | ╢ | ║ |  |  | \+ |  | D | o | o | r |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | ═ | ═ | ═ | ═ | ═ | \+ |  |  | ╟ |  | R | o | l | l | e | r |  | o | n |  | E | W |  | t | r | a | c | k | , |  | r | o | l | l | i | n | g |  | e | a | s | t |  | ( | L | o | w | e | s | t |  | s | p | e | e | d | ) |
|  |  |  |  |  |  |  |  |  | ╢ |  | R | o | l | l | e | r |  | o | n |  | E | W |  | t | r | a | c | k | , |  | r | o | l | l | i | n | g |  | w | e | s | t |  | ( | L | o | w | e | s | t |  | s | p | e | e | d | ) |
...
As a complement to a standard danger room, a **coinstar** or **popcorn** room trains armor user skills via repeated (unblockable/undodgeable) impacts of small objects such as coins. The safest training material is currently unknown (since the bug which made coins completely harmless has been fixed), though coins (split into stacks of 15 or smaller), seeds, socks, leaves, and other small, light objects are likely contenders. Note that unarmored dwarves may experience injuries; a full suit of armor is recommended for coinstar training.
...
Training a single dwarf at a time is recommended because only the "top" unit in a stack will be hit by flying objects. This method does not train weapons, shield use, or dodging, but it quickly trains Armor User and, more importantly, increases vital stats. There are some advantages to using slightly larger objects such as cats (injuries train willpower and hospital staff), however infections from broken ears can prove quite deadly. Read the original forum thread for more useful information (including how to split coin stacks, passive training method and dangers of it).
...
It's possible to simultaneously train swimming by arranging a means of flooding your danger room and locking your military within. (A depth of 4/7 is recommended, but you can fill it up to 6/7 if you ~~dare~~ want.)
...
Using danger rooms or coinstar rooms is especially Fun in the current version, for it will almost certainly wound or kill anyone who uses it.v0.43.04
...
|  |
|----|
| "Danger room" in other / Languages / Dwarven / : / kezat mosus / Elven / : / eduma imira / Goblin / : / ugot xustxu / Human / : / ases coni |
