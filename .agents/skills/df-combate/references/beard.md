...
> Fonte: [Beard](https://dwarffortresswiki.org/index.php/Beard) — Dwarf Fortress Wiki (GFDL/MIT)

Many creatures in the game (even humans) have a group of tissues which are together known as a **beard**. The most common type of beard a player will encounter is the dwarf beard.

## Dwarven beards

A dwarven 'beard' consists of both his cheek whiskers and his chin whiskers, and is specific to males. (Code to enable female beards is in creature_standard.txt, but commented out by default.) The game keeps track of a hidden 'length' attribute for each tissue. At birth, a male baby dwarf has a beard of length zero. After that, they gain 1 length every day until they have 1000 length.
