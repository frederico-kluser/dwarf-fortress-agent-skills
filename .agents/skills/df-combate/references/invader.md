...
The presence of invaders can be customized in `Settings`→`Difficulty`; changing to `Enemies: Off` will disable invaders (though this will not prevent intrigue or HFS), or by clicking the Custom Settings button, more fine-tuning (such as adjusting the type and frequency of enemies) may be done.
...
- Invading creatures can do so regardless of their age, which can lead to rare and unusual events such as being attacked by a werebeast child or a roc hatchling. In the case it is a werebeast, it can still maim your citizens, no matter how young it is.
