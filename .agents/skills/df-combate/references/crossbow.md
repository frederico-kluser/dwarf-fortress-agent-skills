...
> Fonte: [Crossbow](https://dwarffortresswiki.org/index.php/Crossbow) — Dwarf Fortress Wiki (GFDL/MIT)
...
- If squad is assigned multiple ammo types, dwarves with "individual choice ranged" carry wrong ammo. (Fixed in 0.42.03?)
