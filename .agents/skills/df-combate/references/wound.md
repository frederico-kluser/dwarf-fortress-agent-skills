...
> Fonte: [Wound](https://dwarffortresswiki.org/index.php/Wound) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

*"Damage" redirects here; for how weapons do damage, see Weapon*

Seen better days. Fought weaker goblins.\
*Art by Nikolay Persikov*
...
Injuries of a brown recluse spider man.

Injuries of an adder.
...
A wounded character in adventurer mode may be unable to use wounded limbs, or perform actions with them - someone with a mangled arm, for example, cannot wield a sword. Wounds heal over time, but moving even one cell in fast-Travel mode will vastly speed up recovery, instantly healing all injuries that could heal over time. An adventurer with higher recuperation will heal faster than others. Some wounds, however, will never heal.
...
- Getting a lucky roll on a divination die will heal all wounds.
...
- Consuming a healing substance, found in mysterious dungeons and palaces, and held by dungeon guardians, will heal all wounds.

All of these options regrow missing body parts and heal nerve damage.

|  |
|----|
| "Wound" in other / Languages / Dwarven / : / oslan / Elven / : / élitho / Goblin / : / esmên / Human / : / kortil |
