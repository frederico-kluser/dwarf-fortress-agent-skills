...
> Fonte: [Military F.A.Q.](https://dwarffortresswiki.org/index.php/Military_F.A.Q.) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
In the squad screen, Your first squad will be selected with a, whereupon the t option will toggle the squad between its inactive state and its active/ state.
