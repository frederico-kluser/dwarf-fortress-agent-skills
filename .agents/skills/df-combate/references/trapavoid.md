...
> Fonte: [Trapavoid](https://dwarffortresswiki.org/index.php/Trapavoid) — Dwarf Fortress Wiki (GFDL/MIT)

\ Creatures with the **** token cannot be affected by normal traps, and do not set off pressure plates. By ignoring a large part of some players' defenses, such creatures can be difficult to deal with. \

## Creatures who avoid traps

These creatures possess the token.
