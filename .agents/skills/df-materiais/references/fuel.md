...
> Fonte: [Fuel](https://dwarffortresswiki.org/index.php/Fuel) — Dwarf Fortress Wiki (GFDL/MIT)
...
\ No tasks available Check for raw material access and fuel if necessary \
...
- Both charcoal and coke are considered fire-safe building materials.
- If a piece of charcoal or coke (or an item made of these materials) happens to fall in lava, it can generate smoke for several months (related: ), causing unhappy thoughts to dwarves that happen to pass by.
