...
> Fonte: [Mangrove](https://dwarffortresswiki.org/index.php/Mangrove) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
**Mangrove trees** are a type of above ground tree unique to a single biome: the mangrove swamp, a particular type of tropical saltwater swamp in which mangrove trees will grow near rivers and pools of water. Like the overwhelming majority of overland trees, mangrove wood is brown and produces brown products. Mangrove wood is notable for its high density. Logs and leaves can be processed in a dyer's shop into burnt umber dye.
