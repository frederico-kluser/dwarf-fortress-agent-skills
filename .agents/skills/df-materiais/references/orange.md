...
> Fonte: [Orange](https://dwarffortresswiki.org/index.php/Orange) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes orange trees for their fruit.**
- **Biome**
- **Any Tropical**
- **Wet Dry**
- **Wet:** Dry
...
Some dwarves like orange trees for their *fruit*.
...
|  |
|----|
| "Orange" in other / Languages / Dwarven / : / mostib / Elven / : / ÿare / Goblin / : / tustong / Human / : / omthu |
