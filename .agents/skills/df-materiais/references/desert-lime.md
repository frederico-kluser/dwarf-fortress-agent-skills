...
> Fonte: [Desert lime](https://dwarffortresswiki.org/index.php/Desert_lime) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

## Dados (infobox)

- **Urist likes desert lime trees for their fruit.**
- **Biome**
...
It does not actually grow in deserts.

Some dwarves like desert lime trees for their *fruit*.

Admired for its *fruit*.

|  |
|----|
| "Desert lime" in other / Languages / Dwarven / : / zareth rômab / Elven / : / avetho quidole / Goblin / : / slosno xar / Human / : / asto vuli |
