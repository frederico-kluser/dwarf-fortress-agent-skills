...
To improve the efficiency of hauling items to stockpiles, containers, minecarts, and wheelbarrows can be employed. Note, however, that due to a number of outstanding bugs, there are a few cases where these tools *decrease* efficiency; see Bugs for more information.
...
Dwarves with the wood hauling labor enabled will haul wood logs to the corresponding stockpiles. This job usually entails leaving the fortress to get the logs felled on the outside, possibly exposing dwarves to fauna, invaders and sunlight, so you may wish to bar important dwarves from performing this task.
...
To ensure that high-priority hauling tasks (like food), to clean up after get done quickly, you should employ a large number of haulers. This is most important for food hauling, where prepared meals in the kitchen often rot while your dwarves are hauling individual seeds left behind after someone eats a plump helmet, or if your hunters bring a herd of animals in for your butchers all at once.
