...
> Fonte: [Interface](https://dwarffortresswiki.org/index.php/Interface) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
- **D**: The center designation tools shape the world:
  ...
  - l Logging
  - g Gathering
  - v Smoothing and [engra\[v\]ing](/index.php/Engraving "Engraving")
  - x Removing designation orders
  - b Building
  - p [Stock\[p\]iles](/index.php/Stockpile "Stockpile")
  - z Zones
  - U B[U]rrows
  - h Minecart \[h\]aul routes (H could remain in saves created prior 53.09)
  - T Traffic
  - i Melt, dump, hide, or forbid \[i\]tems
