...
> Fonte: [Embark](https://dwarffortresswiki.org/index.php/Embark) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
Medical supplies should be unnecessary to start with, because if you need them ~~you're screwed~~ you'll have Fun. You may want to bring some rope (or just thread) along though.
