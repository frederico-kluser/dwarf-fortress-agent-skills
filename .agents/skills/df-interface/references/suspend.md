...
> Fonte: [Suspend](https://dwarffortresswiki.org/index.php/Suspend) — Dwarf Fortress Wiki (GFDL/MIT)

**Suspending** a task prevents dwarves from working on the task but does not remove the order. Suspension of tasks can occur either on purpose, through the menu's uspend command, or can happen when dwarves are frightened away from a task like building a wall. Suspended tasks are marked with a red **S**.
