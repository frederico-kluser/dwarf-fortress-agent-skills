...
> Fonte: [Justice](https://dwarffortresswiki.org/index.php/Justice) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

When you forget the Baron's demands for 3 flutes.\
*Art by MK01*
...
- Con - prisoners throwing tantrums can break their chains and attack anybody nearby (including the haulers refilling their food/drink stockpiles)
...
- A local position holder with [`[PUNISHMENT_EXEMPTION]`](/index.php/Position_token#PUNISHMENT_EXEMPTION "Position token")
...
"Thank the gods I only got assigned a long-term jail time followed by a hammering. My partner in crime was assigned to a guard beating, poor bastard's head got pulped after one punch." -Urist Mc. Murderhobo.

|  |
|----|
| "Justice" in other / Languages / Dwarven / : / imketh / Elven / : / leÿa / Goblin / : / aka / Human / : / takru |
