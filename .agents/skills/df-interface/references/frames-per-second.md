...
> Fonte: [Frames per second](https://dwarffortresswiki.org/index.php/Frames_per_second) — Dwarf Fortress Wiki (GFDL/MIT)
...
By default, the FPS cap can be modified in-game by using - to increase the FPS cap and - to decrease it.
