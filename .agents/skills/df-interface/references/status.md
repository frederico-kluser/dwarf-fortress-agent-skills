...
> Fonte: [Status](https://dwarffortresswiki.org/index.php/Status) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
The total population and how many are at each of seven various stress levels. To see who is at which level, the Creatures window can be sorted by stress.
