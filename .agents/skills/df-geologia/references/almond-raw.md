...
> Fonte: [Almond/raw](https://dwarffortresswiki.org/index.php/Almond/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[PLANT:ALMOND] prunus dulcis
	...
	[USE_MATERIAL_TEMPLATE:WOOD:WOOD_TEMPLATE]
		...
		[PREFIX:NONE]
	 	[SOLID_DENSITY:795] Can't find sources for almond, going for plum which is in same genus 
