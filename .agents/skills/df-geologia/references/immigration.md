...
> Fonte: [Immigration](https://dwarffortresswiki.org/index.php/Immigration) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
The two hardcoded waves may not show up for a while if the fort does not start on the 15th day of Granite. Note that there may be various reasons for a hardcoded migrant wave to not show up at all, such as if it were blocked by a siege, or if it is not the first fort in the world.[\[1\]](/index.php/DF2014_Talk:Immigration "DF2014 Talk:Immigration")

To be eligible for immigration, the migrant must be a dwarf (or the same race as the fortress in a modded playthrough) and a citizen of your civilization. Nobles who are [`[DUTY_BOUND]`](/index.php/Position_token#DUTY_BOUND "Position token") will never emigrate from their site.
...
- If you missed a moment migrant wave arrive, you can check new dwarves by using DFHack command list-waves.
...
- Carpenters: Like blacksmiths, but they use wood instead of metal. Only source of quality beds and some newer items, like display cases and musical instruments. Also, only leather shields are lighter than wood.

- Stone carvers: Most fortresses cannot afford to make every piece of furniture out of metal or wood - stone is the traditional dwarven option, though it is a bit lacking in value as a material.
...
- Engravers: Engraving is not usually needed in a new fort but is a huge boost in value and good thoughts in a mature one. A good engraver can smooth and detail a large zone in *minutes*, shooting its quality sky-high, while a novice might take hours. Novice engravers also can take quite a while to train.
...
- Metalcrafters: You may not want to fill the next caravan with \*silver goblets\* and other metal finished goods, but making ≡gold chains)≡ for your guard animals and exotic pets is pretty dwarfy.
...
- Beekeepers, Wax workers, and Pressers: Beekeeping is interesting, but it isn't possible in biomes that lack honey bees (and note that bumblebees cannot be~~e~~ domesticated). If you do get a beekeeping business going, wax workers and pressers become viable as well, since they use the products of beekeeping in their labors; otherwise, they are basically useless.
...
- Children: Cannot perform any labors (*save for chores). At least you will have a peasant...in about 18 years.*
