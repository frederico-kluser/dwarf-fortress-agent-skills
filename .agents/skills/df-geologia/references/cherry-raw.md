...
> Fonte: [Cherry/raw](https://dwarffortresswiki.org/index.php/Cherry/raw) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
[PLANT:CHERRY] prunus avium
	...
	[USE_MATERIAL_TEMPLATE:WOOD:WOOD_TEMPLATE]
		...
		[PREFIX:NONE]
	 	[SOLID_DENSITY:425] *** varies by type -- I couldn't find the data for prunus avium, I'm approximating it to prunus pennsilvanica (wild red cherry) 
http://www.csudh.edu/oliver/chemdata/woods.htm

	 	[STATE_COLOR:ALL_SOLID:GOLD] *** approximated to black american cherry 
https://www.woodworkerssource.com/shop/category/Cherry.html
