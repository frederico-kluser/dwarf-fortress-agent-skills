...
> Fonte: [Monastery](https://dwarffortresswiki.org/index.php/Monastery) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

\
**Monasteries** ( / ○) are a type of religious site, taking up a 3×3 square of tiles on an embark map, and are built by monastic orders, which are headed by an abbot.
