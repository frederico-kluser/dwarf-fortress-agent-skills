...
> Fonte: [Personality value](https://dwarffortresswiki.org/index.php/Personality_value) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.

xTATTEREDx  · +FINE+  · \*SUPERIOR\*  · ≡EXCEPTIONAL≡  · ☼MASTERWORK☼

Randomly generated personality of a miner.

**Personality values**, as distinct from attributes and mannerisms, can be found for a creature in the second sub-tab of the "Personality" tab of its character sheet. In general, these do not have as important a gameplay effect as attributes, at least for skill rolls, but they have a major effect on how a dwarf reacts emotionally to various circumstances, which can have crippling effects.

These describe a creature's beliefs; examples include things like tradition ("He/she holds the maintenance of tradition as one of the highest ideals"), cooperation ("...is thoroughly disgusted by cooperation"), and sacrifice ("...believes that those who sacrifice for others should be deeply respected"). Values can conflict with facets, but this doesn't mean they are incompatible. For instance, it's possible a dwarf will deeply value romance, even though one of their personality facets prevents him/her from forming romantic bonds. This particular combination would show up in the "Traits" sub-tab of the "Personality" tab of the creature's character screen as "S/he never falls in love or develops positive feelings toward anything, and s/he is bothered by this since s/he sees romance as one of the highest ideals".
...
Gets a happy thought when speaking to the Champion
...
Gets an unhappy thought when speaking to the Champion
...
Low cooperation may inhibit guildhall demonstrations.
...
Those who value introspection will enjoy libraries and reading and writing books.
...
A dwarf with high self control can go longer without alcohol.
...
PERSEVERANCE / (not to be confused with the / PERSEVERANCE facet / )
+41 to +50
...
Receives happy thought when slaughtering/caging animals and felling trees, always gets annoyed when rained on.v0.42.01
...
cannot learn Pacifier / (unless overridden by extreme DISCORD)
...
Low knowledge will prevent the ability to become a scholar.
