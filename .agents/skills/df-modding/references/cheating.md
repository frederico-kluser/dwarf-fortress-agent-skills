...
> Fonte: [Cheating](https://dwarffortresswiki.org/index.php/Cheating) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
For making modifications to a newly-generated world, edit the raw files located in the `\data\vanilla\` *before* generating the game.
...
People in this game (animals and even inanimate beings, too) are individuals governed by personality traits.
...
---
*Parte 1 de 2 de «Cheating». Demais partes em arquivos `...-part-{1..2}.md` na mesma pasta. Fonte: https://dwarffortresswiki.org/index.php/Cheating*
