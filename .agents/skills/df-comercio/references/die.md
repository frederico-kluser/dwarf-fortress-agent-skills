...
> Fonte: [Die](https://dwarffortresswiki.org/index.php/Die) — Dwarf Fortress Wiki (GFDL/MIT)
...
- **Creates a random artifact-quality piece of armor at the tile where the die was rolled**
...
- **Grants the user an enhanced healing factor, capable of completely healing any tissue damage or other wounds rapidly (duration appears indefinite, but cannot heal certain past wounds)**
...
- emove it from any containers you're carrying it in, or,

- with a hand empty, et it from the ground or a pedestal;

then nteract with the die, selecting the "roll" option.

Your character will then "Divine the will of `` according to the practice of ``".

## Bugs

- The "beast transformation" curse seems to be treated as a normal syndrome, and, thus, can be instantly healed by simply unloading the cell (fast travelling, sleeping). However, the victim appears to suffer stat penalties afterwards, as though they still had their animal body.
- Dice may, under unknown circumstances, respawn even after being taken from their home shrine, after a cell reload.

- Some dwarves love to roll dice and play games about dungeons and dragons.
