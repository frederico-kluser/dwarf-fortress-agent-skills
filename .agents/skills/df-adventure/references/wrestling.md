...
> Fonte: [Wrestling](https://dwarffortresswiki.org/index.php/Wrestling) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
Fighting creatures with wrestling moves
...
Wrestling in adventurer mode can be performed by standing next to an enemy and pressing W, selecting (and perhaps confirming) the enemy you wish to fight, and then choosing a wrestling move. You can wrestle any enemy, but the effectiveness of your wrestling attempts will be limited by relative size and strength differences (for example, a dwarf is unlikely to be able to throw or choke-hold an elephant or dragon). Unconsciousness renders a creature vulnerable to wrestling regardless of size differences.
...
2.  Select Grab upper body with right upper arm  or some other part of the body. If the grab is successful, you will see:
    -  You grab the by the upper body with your right upper arm!  and you and your opponent's icons will change to indicate that you are wrestling.
...
6.  You will then see one of:
    - You take the down by the upper body with your right upper arm!\
      Success! The creature's status icon will change to indicate being prone.
    - You adjust the grip of your right upper arm on the 's upper body.\
      Failure. You have not lost your grip, but you will have to try the takedown again.
    - The breaks the grip of your right upper arm from the 's upper body!\
...
6.  You will then see:
    - You place a chokehold on the 's throat with your right upper arm!\
      Success, so far anyway.
    - You adjust the grip of your right upper arm on the 's throat.\
...
10. If successful you will see:
    - You strangle 's throat!
    - The passes out. (not necessarily on the first try)
...
5.  Select Lock right shoulder with right upper arm. If successful, you will see:
    - You lock the 's right shoulder with your right upper arm!
...
8.  Select Break right shoulder with right upper arm If successful, you will see:
    - You bend the 's right upper arm with your right upper arm, shattering the right shoulder's bone!
...
1.  Choose to A strike and select an enemy (**not** to wrestle!).
...
5.  Choose your enemy, this time opting to W wrestle.
6.  You will now see an option like Wrestle with upper front tooth. Select that option.
7.  Select Shake with upper front tooth
8.  This should do some amount of damage, ranging from tissue layer damage, to ripping the body part completely off. If you bit down on the throat, for example, and were very successful, you will see:
    - You shake the around by the throat, tearing apart the throat!
...
5.  Select Gouge left eye with left hand or Pinch with left hand, or whatever seems good. If successful you will see something like:
    - You gouge the 's left eye with your left hand, tearing it apart!

Pinching can do anything from tissue damage to severing the body part.

### Interrupting

If you know how a creature is attacking, you can try interrupting the attack with a grab. Incoming attacks are shown in the combat menu (A and W), and the main attribute that determines how well you can see incoming attacks is the Observer skill. To interrupt an attack, you must have a hand free (Use q to strap any weapons you're holding to your upper body, if necessary).

1.  Press W and check if there is an incoming attack like Attacking you with right hand punch
...
1.  Select Grab with left hand
2.  Now, scroll down toward the bottom of the list of body parts and you will see items that you can grab a hold of. Select Grab with left hand
3.  Assuming you hit, press I (advanced interaction) and scroll through your inventory until you see the item in your left hand listed in red. Select it. Shared items can also be found in the W wrestling menu.
