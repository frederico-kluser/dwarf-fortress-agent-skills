...
> Fonte: [Adventurer mode F.A.Q.](https://dwarffortresswiki.org/index.php/Adventurer_mode_F.A.Q.) — Dwarf Fortress Wiki (GFDL/MIT)
...
- In version 0.42.01, it is now possible to be "cursed" by a god into becoming a vampire by desecrating statues/totems/altars dedicated to them. This can be done by pressing while adjacent to interact with them, and toppling them.
...
- In version 0.42.01, it is now possible to be "cursed" by a god into becoming a werebeast by desecrating statues, totems or altars dedicated to them. This can be done by pressing while adjacent to interact with them, and toppling them.
...
### I don't like the location I am currently at. How can I fast travel away?
