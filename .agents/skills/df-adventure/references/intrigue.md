...
> Fonte: [Intrigue](https://dwarffortresswiki.org/index.php/Intrigue) — Dwarf Fortress Wiki (GFDL & MIT). Snapshot 2026-06.
...
The main mechanic works through agreements: historical figures reach out to one another and use a variety of tactics (persuasion, blackmail, bribes) to reach an agreement for a variety of things like funding, assassination, stealing. The historical figures keep a list of plots that they want to enact, and also keep track of how to deal with a variety of other figures. They make use of the schemer-skill.
