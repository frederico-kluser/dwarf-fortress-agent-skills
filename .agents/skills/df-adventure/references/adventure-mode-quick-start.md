...
> Fonte: [Adventure mode quick start](https://dwarffortresswiki.org/index.php/Adventure_mode_quick_start) — Dwarf Fortress Wiki (GFDL/MIT)
...
- Increasing mineral frequency (to, say, ) may increase your equipment choices.
...
Once you have finished character creation, hit the key at any time and select to save your game. You can then come back to it later by using the option in the main menu.

### Setting off

You will usually start your adventure in a peasant hut (if you're a **Peasant**) or a mead hall in a keep (if you're a ). You can talk to nearby people using the key, and to learn of any quests you can take on. Some of the more common types you may be told about are:
...
Note that you have to press each time you want to continue the conversation; and select the appropriate ongoing conversation. If someone else is said to know where to go, you may ask for the whereabouts of that person through
...
You will get hungry or thirsty after some time, indicated by the or attributes respectively. As you should know, when this appears, it's time for a snack. To eat or drink, press and locate some food - it can be anything, as long as it's actually food - you can "eat" something like a sword, but the dialog will say "You lick the sword", and you will not get less hungry or thirsty.
...
At this point, you may have traveled enough that your character is tired. When your adventurer becomes tired, as indicated by the attribute, it's time for some sleep. Move to a settlement of some sort, go into a building, and use the key to bring up the sleep menu.
...
Once you complete your first quest, you can talk to any hamlet, town or fortress dweller to spread the news of your success. isn't as effective as . It is not necessary to return to the individual who told you about the trouble to report your success. Telling the story in the form of a performance is also very effective, as performing forces everyone around you to pay attention to what you're saying.
...
After you've armoured up a bit, it's probably safe to go on the next quest. Get as many companions as you can and set off for your next target. You can also , which can reveal lairs and other hidden sites on the map. You should probably avoid any non-quest lairs in the beginning, though, as lairs and such can have creatures that you won't be able to handle at this point.
...
Thread about this tutorial on the Bay12 Forums
